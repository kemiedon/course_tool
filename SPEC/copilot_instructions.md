...
- ✅ 已讀本檔案（copilot-instructions.md）

- ✅ 確認當前任務類型：bug / feature / refactor / docs / 其他

- ✅ 檢查是否需要更新 `.github/conversation-logs/`（見本檔案末尾）

- ✅ 掌握核心規範：語言風格、命名規則、共享元件強制規定

- ✅ 遵守 Git Commit 規範（見下方）
